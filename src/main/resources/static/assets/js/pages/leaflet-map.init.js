...
// MAPBOX_ACCESS_TOKEN should be defined in a config file or environment variable
// For development, create a file: leaflet-map-config.js with:
// const MAPBOX_ACCESS_TOKEN = 'your_mapbox_token_here';
const MAPBOX_ACCESS_TOKEN = typeof window.MAPBOX_ACCESS_TOKEN !== 'undefined'
...
var mbAttr = 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, ' +
    '<a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, ' +
    'Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
    mbUrl = 'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=' + MAPBOX_ACCESS_TOKEN;
